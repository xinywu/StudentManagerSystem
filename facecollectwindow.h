#ifndef FACECOLLECTWINDOW_H
#define FACECOLLECTWINDOW_H
...
namespace Ui {
class FaceCollectWindow;
}

class FaceCollectWindow : public QMainWindow
{
    Q_OBJECT

public:
    explicit FaceCollectWindow(QWidget *parent = 0);
    ~FaceCollectWindow();
